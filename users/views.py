...
USER_CREATION_MESSAGE =  "Dear %s, You have just been registered on the Interintel platform with " \
...
def activate_account(request):
    """
    Endpoint: /users/activate_account/
    Method: PUT
    Allowed users: Users registered by the system
    Response status code: 200 success
    Description: Created users can activate account then change password here
    """
